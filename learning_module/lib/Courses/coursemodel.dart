...
class LessonModel
{
  ...
  LessonModel({this.id,this.coursename,this.description,this.coursecreator,this.createdate,this.introvideo,this.languages,this.lastupdate,this.price,this.requirements,this.level,this.shortdescription,this.thumbnail});
  factory LessonModel.fromJson(Map<dynamic,dynamic> json){
    return LessonModel(
      id:json['id'] ,
      coursename: json['Course_title'].toString(),
      coursecreator:json['Course_creatore'],
