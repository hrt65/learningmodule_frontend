...
import 'package:learning_module/Lessons/Quiz/answer.dart';
...
class _QuizQuestionsState extends State<QuizQuestions> {
  ...
  getquestionlist() async {
    QuizModel quiztemp = await getQuiz(1);
    questionlist = quiztemp.questionlist;
    return true;
  }
  ...
  void _questionAnswered(bool answerScore) {
    setState(() {
      ...
      //when the quiz ends
      if (_questionIndex + 1 == questionlist!.length) {
        endOfQuiz = true;
      }
    });
  }
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        (snapshot.data as List)[_questionIndex]['question'] as String,
                  ...
                  ...((snapshot.data as List)[_questionIndex]['answers']
                  ...
                  Container(
                    ...
                    child: Text(
                      '${_totalScore.toString()}/${questionlist!.length}',
                      style: TextStyle(
